...
function insert_table_geoname ($nom_géoname,$num_départ,$id_URL)

{
  ...
  $link=$db->connect();
  $sql = "INSERT INTO `geoname` ( `num_géoname` , `nom_géoname` , `num_départ` , `id_URL` ) VALUES ('', '$nom_géoname', '$num_départ', '$id_URL')";     
  $result = $db->query($sql);
  $db->close($link);
