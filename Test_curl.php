...
require("library/php/Curl_exec.php");
  ...
  if (count($matches)>0)
   {
    ...
    $depute_object=new depute ($link_page1);
    
    $result1=$depute_object->recup_fiche_deput ($link_page1);

    $nom1=$depute_object->recup_nom_deput ($result1);
    $prenom1=$depute_object->recup_nom_deput ($result1);
    $num_depart1=$depute_object->recup_num_depart_deput ($result1);
    $mail1=$depute_object->recup_mail_deput ($result1);
    $lien_AN_deput1=$depute_object->recup_lien_AN_deput ($result1);
    
    $result_insert_deput=$depute_object->insert_table_depute ($nom1,$prenom1,$mail1,$lien_AN_deput1,$num_depart1);
